...
public interface Extractor<T> {
     ...
     * @throws ReadException when an IO/parse error occurs or the file is missing
     */
    List<T> extract() throws EmptyInputException, ReadException;

    /** Thrown when the input exists but has no data rows. */
    class EmptyInputException extends Exception {
        public EmptyInputException(String msg) { super(msg); }
    }
    /** Thrown for I/O or parse errors. */
    class ReadException extends Exception {
        public ReadException(String msg, Throwable cause) { super(msg, cause); }
        public ReadException(String msg) { super(msg); }
    }
}